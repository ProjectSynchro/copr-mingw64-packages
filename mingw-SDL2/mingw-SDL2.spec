...
# UCRT64
%package -n ucrt64-SDL2
Summary:        MinGW Windows port of SDL cross-platform multimedia library

%description -n ucrt64-SDL2
Simple DirectMedia Layer (SDL) is a cross-platform multimedia library
designed to provide fast access to the graphics frame buffer and audio
device.

# UCRT64 (static)
%package -n ucrt64-SDL2-static
Summary:        MinGW Windows port of SDL cross-platform multimedia library
Requires:       ucrt64-SDL2 = %{version}-%{release}

%description -n ucrt64-SDL2-static
Simple DirectMedia Layer (SDL) is a cross-platform multimedia library
designed to provide fast access to the graphics frame buffer and audio
device.
...
rm -rf %{buildroot}%{ucrt64_datadir}/licenses
...
%files -n ucrt64-SDL2
%license LICENSE.txt
%{ucrt64_bindir}/SDL2.dll
%{ucrt64_bindir}/sdl2-config
%{ucrt64_libdir}/libSDL2.dll.a
%{ucrt64_libdir}/libSDL2main.a
%{ucrt64_libdir}/libSDL2_test.a
%{ucrt64_libdir}/cmake/SDL2/
%exclude %{ucrt64_libdir}/cmake/SDL2/*static*
%{ucrt64_libdir}/pkgconfig/sdl2.pc
%{ucrt64_datadir}/aclocal/sdl2.m4
%{ucrt64_includedir}/SDL2

# UCRT64 (static)
%files -n ucrt64-SDL2-static
%{ucrt64_libdir}/libSDL2.a
