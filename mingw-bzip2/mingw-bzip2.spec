...
# UCRT64
%package -n ucrt64-bzip2
Summary:        ucrt version of bzip2 for Windows

%description -n ucrt64-bzip2
Bzip2 is a freely available, patent-free, high quality data compressor.
Bzip2 compresses files to within 10 to 15 percent of the capabilities
of the best techniques available.  However, bzip2 has the added benefit
of being approximately two times faster at compression and six times
...
%package -n ucrt64-bzip2-static
Summary:        Static library for mingw64-bzip2 development
Requires:       ucrt64-bzip2 = %{version}-%{release}

%description -n ucrt64-bzip2-static
Static library for ucrt64-bzip2 development.
...
for dir in $RPM_BUILD_ROOT%{mingw32_bindir} $RPM_BUILD_ROOT%{mingw64_bindir} $RPM_BUILD_ROOT%{ucrt64_bindir}; do
pushd $dir
...
# UCRT64
%files -n ucrt64-bzip2
%doc COPYING
%{ucrt64_bindir}/libbz2-1.dll
%{ucrt64_bindir}/bunzip2.exe
%{ucrt64_bindir}/bzcat.exe
%{ucrt64_bindir}/bzcmp
%{ucrt64_bindir}/bzdiff
%{ucrt64_bindir}/bzegrep
%{ucrt64_bindir}/bzfgrep
%{ucrt64_bindir}/bzgrep
%{ucrt64_bindir}/bzip2.exe
%{ucrt64_bindir}/bzip2recover.exe
%{ucrt64_bindir}/bzless
%{ucrt64_bindir}/bzmore
%{ucrt64_includedir}/bzlib.h
%{ucrt64_libdir}/libbz2.dll.a
%{ucrt64_libdir}/pkgconfig/bzip2.pc

%files -n ucrt64-bzip2-static
