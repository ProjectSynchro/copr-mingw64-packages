...
BuildRequires:  ucrt64-libjpeg-turbo
...
# UCRT64
%package -n ucrt64-libtiff
Summary:        MinGW Windows port of the LibTIFF library

%description -n ucrt64-libtiff
The libtiff package contains a library of functions for manipulating
TIFF (Tagged Image File Format) image format files.  TIFF is a widely
used file format for bitmapped images.  TIFF files usually end in the
.tif extension and they are often quite large.
...
%package -n ucrt64-libtiff-static
Summary:        Static version of the MinGW Windows LibTIFF library
Requires:       ucrt64-libtiff = %{version}-%{release}

%description -n ucrt64-libtiff-static
Static version of the MinGW Windows LibTIFF library.
...
export UCRT64_CFLAGS="%{ucrt64_cflags} -fno-strict-aliasing"
...
rm -f $RPM_BUILD_ROOT%{ucrt64_bindir}/*.exe
...
%{ucrt64_libdir}/pkgconfig/libtiff-4.pc

%files -n ucrt64-libtiff-static
%{ucrt64_libdir}/libtiff.a
