...
# Win64
%files -n ucrt64-gettext -f ucrt64-%{name}.lang
%license COPYING
...
%{ucrt64_bindir}/libgettextlib-0-22-5.dll
%{ucrt64_bindir}/libgettextpo-0.dll
%{ucrt64_bindir}/libgettextsrc-0-22-5.dll
...
%changelog
* Mon Aug 19 2024 Jack Greiner <jack@emoss.org> - 0.22.5-4
