...
# UCRT64
%package -n ucrt64-freetype
Summary:        Free and portable font rendering engine

%description -n ucrt64-freetype
MinGW Windows Freetype library.

%package -n ucrt64-freetype-static
Summary:        Static version of the MinGW Windows Freetype library
Requires:       ucrt64-freetype = %{version}-%{release}

%description -n ucrt64-freetype-static
Static version of the MinGW Windows Freetype library.
...
%files -n ucrt64-freetype
%license LICENSE.TXT
%{ucrt64_bindir}/freetype-config
%{ucrt64_bindir}/libfreetype-6.dll
%{ucrt64_includedir}/freetype2
%{ucrt64_libdir}/libfreetype.dll.a
%{ucrt64_libdir}/pkgconfig/freetype2.pc
%{ucrt64_datadir}/aclocal/freetype2.m4

%files -n ucrt64-freetype-static
%{ucrt64_libdir}/libfreetype.a
