...
# UCRT64
%package -n ucrt64-SDL2_mixer
Summary:        MinGW Windows port of Simple DirectMedia Layer's Sample Mixer Library

%description -n ucrt64-SDL2_mixer
A simple multi-channel audio mixer for SDL2. It supports 4 channels of
16 bit stereo audio, plus a single channel of music, mixed by the popular
MikMod MOD library.
...
# UCRT64
%files -n ucrt64-SDL2_mixer
%license LICENSE.txt
%{ucrt64_bindir}/SDL2_mixer.dll
%{ucrt64_libdir}/libSDL2_mixer.dll.a
%{ucrt64_libdir}/cmake/SDL2_mixer/
%{ucrt64_libdir}/pkgconfig/SDL2_mixer.pc
