...
%package -n ucrt64-flac
Summary:        %{summary}

%description -n ucrt64-flac
FLAC stands for Free Lossless Audio Codec. Grossly oversimplified, FLAC
is similar to Ogg Vorbis, but lossless. The FLAC project consists of
the stream format, reference encoders and decoders in library form,
flac, a command-line program to encode and decode FLAC files, metaflac,
...
This package is MinGW compiled flac library for the UCRT64 target.


%package -n ucrt64-flac-tools
Summary:        Tools for Free Lossless Audio Codec
Requires:       ucrt64-flac = %{version}-%{release}

%description -n ucrt64-flac-tools
FLAC stands for Free Lossless Audio Codec. Grossly oversimplified, FLAC
is similar to Ogg Vorbis, but lossless. The FLAC project consists of
the stream format, reference encoders and decoders in library form,
flac, a command-line program to encode and decode FLAC files, metaflac,
...
This package is MinGW compiled flac tools for the UCRT64 target.
...
rm -rf %{buildroot}%{ucrt64_docdir}/flac*
...
%doc AUTHORS README.md
%license COPYING*
%{ucrt64_bindir}/libFLAC-12.dll
%{ucrt64_bindir}/libFLAC++-10.dll
%{ucrt64_includedir}/*
%{ucrt64_libdir}/libFLAC.dll.a
%{ucrt64_libdir}/libFLAC++.dll.a
%{ucrt64_libdir}/pkgconfig/flac.pc
%{ucrt64_libdir}/pkgconfig/flac++.pc
%{ucrt64_datadir}/aclocal/libFLAC.m4
%{ucrt64_datadir}/aclocal/libFLAC++.m4

%files -n ucrt64-flac-tools
%{ucrt64_bindir}/*.exe

%changelog
* Mon Aug 19 2024 Jack Greiner <jack@emoss.org> - 1.4.3-2
