...
# UCRT64
%package -n ucrt64-SDL3
Summary:        MinGW Windows port of SDL cross-platform multimedia library
Provides:       bundled(hidraw)

%description -n ucrt64-SDL3
Simple DirectMedia Layer (SDL) is a cross-platform multimedia library
designed to provide fast access to the graphics frame buffer and audio
device.

# UCRT64 (static)
%package -n ucrt64-SDL3-static
Summary:        MinGW Windows port of SDL cross-platform multimedia library
Requires:       ucrt64-SDL3 = %{version}-%{release}

%description -n ucrt64-SDL3-static
Simple DirectMedia Layer (SDL) is a cross-platform multimedia library
designed to provide fast access to the graphics frame buffer and audio
device.
...
%files -n ucrt64-SDL3
%license LICENSE.txt
%{ucrt64_bindir}/SDL3.dll
%{ucrt64_libdir}/libSDL3.dll.a
%{ucrt64_libdir}/libSDL3_test.a
%{ucrt64_libdir}/cmake/SDL3/
%exclude %{ucrt64_libdir}/cmake/SDL3/*static*
%{ucrt64_libdir}/pkgconfig/sdl3.pc
%{ucrt64_includedir}/SDL3

# UCRT64 (static)
%files -n ucrt64-SDL3-static
%{ucrt64_libdir}/libSDL3.a
%{ucrt64_libdir}/cmake/SDL3/*static*

%changelog
* Fri Jul 13 2025 Jack Greiner <jack@emoss.org> - 3.2.16-2
- Update to 3.2.16
