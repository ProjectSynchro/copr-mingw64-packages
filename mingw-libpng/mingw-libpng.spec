...
# UCRT64
%package -n ucrt64-libpng
Summary:        MinGW Windows Libpng library
Requires:       pkgconfig

%description -n ucrt64-libpng
MinGW Windows Libpng library.

%package -n ucrt64-libpng-static
Summary:        Static version of MinGW Windows Libpng library
Requires:       ucrt64-libpng = %{version}-%{release}

%description -n ucrt64-libpng-static
MinGW Windows Libpng library.
...
# UCRT64
%files -n ucrt64-libpng
%license LICENSE
%doc ANNOUNCE CHANGES README TODO
%{ucrt64_bindir}/libpng-config
%{ucrt64_bindir}/libpng16-16.dll
%{ucrt64_bindir}/libpng16-config
%{ucrt64_bindir}/png-fix-itxt.exe
%{ucrt64_bindir}/pngfix.exe
%{ucrt64_includedir}/libpng16
%{ucrt64_includedir}/png.h
%{ucrt64_includedir}/pngconf.h
%{ucrt64_includedir}/pnglibconf.h
%{ucrt64_libdir}/libpng.dll.a
%{ucrt64_libdir}/libpng16.dll.a
%{ucrt64_libdir}/pkgconfig/libpng.pc
%{ucrt64_libdir}/pkgconfig/libpng16.pc

%files -n ucrt64-libpng-static
%{ucrt64_libdir}/libpng.a
