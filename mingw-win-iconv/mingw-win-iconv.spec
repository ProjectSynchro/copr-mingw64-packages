...
# Win64
%package -n ucrt64-win-iconv
Summary:       MinGW Windows Iconv library
Obsoletes:     ucrt64-iconv < 1.13.1-2%{?dist}
Provides:      ucrt64-iconv = 1.13.1-2%{?dist}

%description -n ucrt64-win-iconv
MinGW Windows Iconv library

%package -n ucrt64-win-iconv-static
Summary:       Static version of the MinGW Windows Iconv library
Requires:      ucrt64-win-iconv = %{version}-%{release}
Obsoletes:     ucrt64-iconv-static < 1.13.1-2%{?dist}
Provides:      ucrt64-iconv-static = 1.13.1-2%{?dist}

%description -n ucrt64-win-iconv-static
Static version of the MinGW Windows Iconv library.
...
rm -rf %{buildroot}%{ucrt64_bindir}/*.exe
...
%files -n ucrt64-win-iconv
%doc ChangeLog readme.txt
%{ucrt64_bindir}/iconv.dll
%{ucrt64_includedir}/iconv.h
%{ucrt64_libdir}/libiconv.dll.a

%files -n ucrt64-win-iconv-static
%{ucrt64_libdir}/libiconv.a

%changelog
* Mon Aug 19 2024 Jack Greiner <jack@emoss.org> - 0.0.8-14
