...
chmod 0644 %{buildroot}%{ucrt64_libdir}/*.dll.a
...
%license LICENCE
%{ucrt64_bindir}/pcre2grep.exe
%{ucrt64_bindir}/pcre2test.exe
%{ucrt64_bindir}/pcre2-config
%{ucrt64_bindir}/libpcre2-8-0.dll
%{ucrt64_bindir}/libpcre2-16-0.dll
%{ucrt64_bindir}/libpcre2-32-0.dll
%{ucrt64_bindir}/libpcre2-posix-3.dll
%{ucrt64_libdir}/libpcre2-8.dll.a
%{ucrt64_libdir}/libpcre2-16.dll.a
%{ucrt64_libdir}/libpcre2-32.dll.a
%{ucrt64_libdir}/libpcre2-posix.dll.a
%{ucrt64_libdir}/pkgconfig/libpcre2-*.pc
%{ucrt64_includedir}/pcre2.h
%{ucrt64_includedir}/pcre2posix.h

%files -n ucrt64-%{pkgname}-static
%license LICENCE
%{ucrt64_libdir}/libpcre2-8.a
%{ucrt64_libdir}/libpcre2-16.a
%{ucrt64_libdir}/libpcre2-32.a
%{ucrt64_libdir}/libpcre2-posix.a


%changelog
* Mon Aug 19 2024 Jack Greiner <jack@emoss.org> - 10.44-3
